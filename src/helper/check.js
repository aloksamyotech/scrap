...
export async function scrapeInstacart(searchURL) {
  ...
  try {
    ...
    await page.goto("https://www.instacart.com/store/razco-foods-supermarket/s?k=Electrolit+Cucumber+Lime");
...
// above code is complete backup code of the current scrapping 22 feb 3 pm  